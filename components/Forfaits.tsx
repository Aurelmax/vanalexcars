...
function ForfaitCard({ title, description, price, features, isPopular = false, isVip = false }: ForfaitProps) {
  return (
    <div className={`relative bg-premium-gray-dark rounded-lg p-8 border-2 transition-all duration-300 hover:scale-105 ${
      ...
      <ul className="space-y-3 mb-8">
        {features.map((feature, index) => (
          <li key={index} className="flex items-start">
            <svg className="w-5 h-5 text-premium-gold mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="mt-16 bg-premium-gray-dark rounded-lg p-8 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-start">
            <svg className="w-6 h-6 text-premium-gold mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <div>
              <h4 className="text-premium-white font-semibold mb-2">Service de proximité</h4>
              <p className="text-premium-gray-light">Expertise en face-à-face en Allemagne, gage de confiance et sécurité accrue</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <h4 className="text-premium-white font-semibold mb-2">Paiement sécurisé</h4>
              <p className="text-premium-gray-light">Paiement garanti uniquement une fois que le client est satisfait du véhicule</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <h4 className="text-premium-white font-semibold mb-2">Flexibilité logistique</h4>
              <p className="text-premium-gray-light">Rapatriement adapté à chaque demande selon vos préférences</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <h4 className="text-premium-white font-semibold mb-2">Transparence totale</h4>
              <p className="text-premium-gray-light">Suivi et documents remis au client à chaque étape</p>
            </div>
          </div>
        </div>
      </div>
