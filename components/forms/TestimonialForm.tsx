...
const TestimonialForm: React.FC = () => {
  ...
  const { values, errors, handleChange, handleSubmit, reset } = useForm<TestimonialFormData>({
    initialValues: {
      name: '',
      email: '',
      location: '',
    ...
    validate: (values) => {
      ...
      if (!values.testimonial.trim()) {
        ...
        errors.testimonial = 'Le témoignage doit faire au moins 50 caractères';
      }
      
      if (!values.consent) {
        errors.consent = 'Vous devez accepter la publication de votre témoignage';
      }
    ...
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label htmlFor="vehicle_purchased" className="block text-sm font-medium text-gray-700 mb-2">
              Véhicule acheté
            </label>
            <input
              type="text"
