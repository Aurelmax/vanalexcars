...
const VehicleRequestForm: React.FC = () => {
  ...
  const { values, errors, handleChange, handleSubmit, reset } = useForm<VehicleRequestFormData>({
    initialValues: {
      name: '',
      email: '',
      phone: '',
    ...
    validate: (values) => {
      ...
      if (values.vehicle_year && (values.vehicle_year < 1990 || values.vehicle_year > new Date().getFullYear() + 1)) {
        errors.vehicle_year = 'L\'année doit être entre 1990 et ' + (new Date().getFullYear() + 1);
      }
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="vehicle_make" className="block text-sm font-medium text-gray-700 mb-2">
              Marque du véhicule *
            </label>
            <select
              id="vehicle_make"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="vehicle_year" className="block text-sm font-medium text-gray-700 mb-2">
              Année souhaitée
            </label>
            <select
              id="vehicle_year"
