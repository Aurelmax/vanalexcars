...
type FormType = 'contact' | 'vehicle' | 'documents' | 'testimonial' | 'newsletter';
...
const FormSelector: React.FC = () => {
  ...
  const getColorClasses = (color: string, isSelected: boolean) => {
    const baseClasses = 'border-2 rounded-lg p-4 cursor-pointer transition-all duration-200 hover:shadow-lg';
