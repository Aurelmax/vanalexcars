...
const FileUploadDemo: React.FC = () => {
  ...
  const totalFiles = identityFiles.length + proofFiles.length + mandateFiles.length;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-center mb-2">
                ...
                <div className="ml-auto">
                  {identityFiles.length > 0 ? (
                    <span className="text-green-600 text-sm">✓ {identityFiles.length} fichier(s)</span>
                  ) : (
            ...
            <div className="bg-white rounded-lg border border-green-200 p-3">
              <div className="flex items-center mb-2">
                ...
                <div className="ml-auto">
                  {proofFiles.length > 0 ? (
                    <span className="text-green-600 text-sm">✓ {proofFiles.length} fichier(s)</span>
                  ) : (
                    <span className="text-gray-400 text-sm">En attente</span>
                  )}
                </div>
              ...
              <div className="flex items-center mb-2">
                ...
                <div className="ml-auto">
                  {mandateFiles.length > 0 ? (
                    <span className="text-green-600 text-sm">✓ {mandateFiles.length} fichier(s)</span>
                  ) : (
                    <span className="text-gray-400 text-sm">En attente</span>
                  )}
                </div>
