<?php
/**
 * Configuration du CPT Form Submissions pour Vanalexcars
...
function vanalexcars_create_form_submissions_cpt() {
    $args = array(
        ...
        'public' => false, // Pas visible sur le frontend
        'show_ui' => true, // Visible dans l'admin
        'show_in_rest' => true, // Accessible via API REST
...
function vanalexcars_form_submission_meta_box_callback($post) {
    ...
    if ($ip_address) {
        echo '<tr><th><label>Adresse IP</label></th>';
        echo '<td>' . esc_html($ip_address) . '</td></tr>';
    }
