<?php
/**
 * Endpoint simple pour les soumissions de formulaires
 * Fonctionne sans authentification
 */

// Enregistrer l'endpoint personnalisé
add_action('rest_api_init', 'vanalexcars_register_simple_form_endpoint');
function vanalexcars_register_simple_form_endpoint() {
    register_rest_route('vanalexcars/v1', '/submit-form', array(
        'methods' => 'POST',
        'callback' => 'vanalexcars_handle_simple_form_submission',
...
function vanalexcars_handle_simple_form_submission($request) {
    ...
    $post_data = array(
        'post_type' => 'post',
        'post_title' => vanalexcars_generate_simple_form_title($form_type, $form_data),
        'post_content' => vanalexcars_generate_simple_form_content($form_type, $form_data),
        'post_status' => 'publish',
        'meta_input' => array(
            'form_type' => $form_type,
            'form_data' => $form_data,
...
function vanalexcars_generate_simple_form_title($form_type, $form_data) {
    $titles = array(
...
function vanalexcars_generate_simple_form_content($form_type, $form_data) {
